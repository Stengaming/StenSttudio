...
if (window.location.search.includes("?snow") || getCookie("snow") === "true") {
    setCookie("snow", "true", 30); // Cookie instellen voor 30 dagen
    startSnowfall();
}
...
function startSnowfall() {
    ...
    function createSnowflake() {
        ...
        snowflake.src = "https://pngimg.com/d/snowflakes_PNG7578.png"; // Pas aan met je eigen PNG
